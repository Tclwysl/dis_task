...
namespace DisTask
{
    ...
    {
        string selectsql = "select detwork_id,detwork_custname,detwork_loan,detwork_type,detwork_project,detwork_mechanism,detwork_manager,detwork_place,detwork_establishtime,detwork_difficulty,detwork_workload from dis_detwork where detwork_bz = '1'";
        //数据库加载函数
        ...
        private void button2_Click(object sender, EventArgs e)//删除
        {
            ...
            {
                MessageBox.Show("即将删除的业务id： " + this.dataGridView1.CurrentRow.Cells[0].Value);
            ...
            {
                MessageBox.Show("您还未选择想要删除的行哦！","提示");
            }
